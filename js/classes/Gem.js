...
Game.Gem = function(x, y, value) {
	...
	var left = (80 * x) + (x + 1) + 'px',
		top = (80 * y) + (y + 1) + 'px',
		gem = document.createElement('section');

	gem.className = 'gem' + value + ' item gem';
	gem.val = value;
	gem.id = 'tile' + y + '_' + x;
	// gem.innerHTML = y+'_'+x;
...
Game.addGemCapabilities = function(gem) {
	...
	/** Compares a gem's value with this gem's value @param {Gem} target 
		The gem to compare with the current object */
	...
	/** Searches for the presence of a gem streak
